    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="error-page">
                <h2 class="headline text-danger">Expired</h2>

                <div class="error-content">
                    <h3><i class="fas fa-exclamation-triangle text-danger"></i> Session Expired!</h3>

                    <p>
                        We're sorry, you have to  <a href="{{route('home')}}">Log in </a> as your session has expired.
